...
|---|---|---|---|---|
| 1 | `order_placed` | `PLACED` | — | `customer_id`, `customer_ingestion_date`, `province_code`, `municipality_code`, `postal_code`, `price_as_of`, `price_source`, `delivery_slot_start`, `delivery_slot_end`, `line_count`, `gross_amount`, `lines[]` |
